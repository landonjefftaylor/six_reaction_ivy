...
while not(finished) and index < indexlimit:
  ...
  new_invariant = " | (spec.s1 = " + s[1] + " & spec.s2 = " + s[2] + " & spec.s3 = " + s[3] + " & spec.s4 = " + s[4] + " & spec.s5 = " + s[5] + " & spec.s6 = " + s[6] + " & spec.r1 = " + r[1] + " & spec.r2 = " + r[2] + " & spec.r3 = " + r[3] + " & spec.r4 = " + r[4] + " & spec.r5 = " + r[5] + " & spec.r6 = " + r[6] + " & spec.q1 = " + q[1] + " & spec.q2 = " + q[2] + " & spec.q3 = " + q[3] + " & spec.q4 = " + q[4] + " & spec.q5 = " + q[5] + " & spec.q6 = " + q[6] + " & spec.p1 = " + p[1] + " & spec.p2 = " + p[2] + " & spec.p3 = " + p[3] + " & spec.p4 = " + p[4] + " & spec.p5 = " + p[5] + " & spec.p6 = " + p[6] + ")"
