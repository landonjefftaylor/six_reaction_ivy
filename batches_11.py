...
while not(finished) and index < indexlimit:
      ...
      for line in trace:
        ...
        if "   spec.l1 = " in line:
          ...
          if clean.isdigit():
            ...
            print("l1 WAS NOT A DIGIT. GOT _" + clean + "_")
        elif "   spec.l2 = " in line:
          spl = line.split(" = ")
          clean = spl[1].rstrip('\n')
          if clean.isdigit():
            l[2] = str(clean)
          else:
            print("l2 WAS NOT A DIGIT. GOT _" + clean + "_")
        if "   spec.l3 = " in line:
          spl = line.split(" = ")
          clean = spl[1].rstrip('\n')
          if clean.isdigit():
            ...
            print("l3 WAS NOT A DIGIT. GOT _" + clean + "_")
        if "   spec.l4 = " in line:
          spl = line.split(" = ")
          clean = spl[1].rstrip('\n')
          if clean.isdigit():
            ...
            print("l4 WAS NOT A DIGIT. GOT _" + clean + "_")
        if "   spec.l5 = " in line:
          spl = line.split(" = ")
          clean = spl[1].rstrip('\n')
          if clean.isdigit():
            ...
            print("l5 WAS NOT A DIGIT. GOT _" + clean + "_")
        if "   spec.l6 = " in line:
          spl = line.split(" = ")
          clean = spl[1].rstrip('\n')
          if clean.isdigit():
            ...
            print("l6 WAS NOT A DIGIT. GOT _" + clean + "_")
  ...
  new_invariant = new_invariant + " & spec.l1 = " + l[1] + " & spec.l2 = " + l[2] + " & spec.l3 = " + l[3] + " & spec.l4 = " + l[4] + " & spec.l5 = " + l[5] + " & spec.l6 = " + l[6] + ")" 
