...
while not(finished) and index < indexlimit:
    ...
    with open(abrfile, 'w') as abr:
      for line in trace:
        ...
        if "   spec.s1 = " in line:
          ...
          if clean.isdigit():
            s[1] = str(clean)
            if not(s[n] == "ERR" for n in s):
              abr.write("s1 " + s[1] + " s2 " + s[2] + " s3 " + s[3] + " s4 " + s[4] + " s5 " + s[5] + " | r1 " + r[1] + " r2 " + r[2] + " r3 " + r[3] + " r4 " + r[4] + " r5 " + r[5] + " " + lastaction + "\n")
          else:
  ...
  new_invariant = " | (spec.s1 = " + s[1] + " & spec.s2 = " + s[2] + " & spec.s3 = " + s[3] + " & spec.s4 = " + s[4] + " & spec.s5 = " + s[5] + " & spec.r1 = " + r[1] + " & spec.r2 = " + r[2] + " & spec.r3 = " + r[3] + " & spec.r4 = " + r[4] + " & spec.r5 = " + r[5] + ")"
